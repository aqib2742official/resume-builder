...
export function SectionHeading({ children, accentColor = '#1e3a5f' }: Readonly<SectionHeadingProps>) {
  ...
  if (headingStyle === 'leftbar') {
    return (
      <div style={{ marginBottom: 7, paddingLeft: 8, borderLeft: `3px solid ${accentColor}` }}>
        <h2 style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: accentColor }}>
          {children}
        </h2>
      </div>
    )
  ...
  if (headingStyle === 'plain') {
    return (
      <div style={{ marginBottom: 7 }}>
        <h2 style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: accentColor }}>
          {children}
        </h2>
      </div>
    )
  ...
  return (
    <div style={{ marginBottom: 6, paddingBottom: 4, borderBottom: `1.5px solid ${accentColor}` }}>
      <h2 style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: accentColor }}>
        {children}
      </h2>
    </div>
  )
